/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c619cb1286465baa5555be67d61f84f)
...
interface __BaseEnv_Env {
  ...
  HQBASE_AGENT_TOKEN: string
  HQBASE_ORIGIN: string
  HQBASE_MAILBOX_ID: string
  HQBASE_MAILBOX_ADDRESS: string
  HQBOT_ALLOWED_SENDERS: string
  ...
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        ...
        | "HQBASE_ORIGIN"
        | "HQBASE_MAILBOX_ID"
        | "HQBASE_MAILBOX_ADDRESS"
        | "HQBOT_ALLOWED_SENDERS"
      >
    > {}
}
