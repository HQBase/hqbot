/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a316ba220555c977485f5faf9ce1b64e)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	HQBOT_ID: "hqbot";
	HQBOT_MODEL_ID: "@cf/deepseek-ai/deepseek-v4-flash-0731";
	HQBOT_AUTO_REPLY: "true";
	HQBOT_OWNER_TOKEN: string;
	HQBOT_CONNECTION_KEY: string;
	HQBOT_AGENT: DurableObjectNamespace<import("./src/worker").HQBotAgent>;
	HQBOT_WORKFLOW: Workflow<Parameters<import("./src/worker").HQBotWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "HQBotAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HQBOT_ID" | "HQBOT_MODEL_ID" | "HQBOT_AUTO_REPLY" | "HQBOT_OWNER_TOKEN" | "HQBOT_CONNECTION_KEY">> {}
}
