/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f3eb24b91904c6e740549ef5f0c04d09)
// Runtime types generated with workerd@1.20260820.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	...
	HQBOT_CONNECTION_KEY: string;
	HQBOT_SETUP_TOKEN: string;
	HQBOT_AGENT: DurableObjectNamespace<import("./src/worker").HQBotAgent>;
	HQBOT_TEAMMATE: DurableObjectNamespace<import("./src/worker").HQBotTeammate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "HQBotAgent" | "HQBotTeammate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HQBOT_ID" | "HQBOT_MODEL_ID" | "HQBOT_FALLBACK_MODEL_ID" | "HQBOT_DAILY_TASK_LIMIT" | "HQBOT_TASK_BUDGET_USD" | "HQBOT_BOT_DAILY_BUDGET_USD" | "HQBOT_GLOBAL_DAILY_BUDGET_USD" | "HQBOT_CONNECTION_KEY" | "HQBOT_SETUP_TOKEN">> {}
}
