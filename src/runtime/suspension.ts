...
export async function suspendTeammateWork(host: SuspensionHost, taskIds: string[]): Promise<void> {
  ...
  for (const submission of submissions) {
    await host.cancelSubmission(submission.submissionId, "The owner archived this teammate");
  }
